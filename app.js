...
const Menu = props => {
  return (
    ...
    React.createElement("a", { href: "#welcome-section", onClick: props.toggleMenu }, "ANA SAYFA")),



    React.createElement("li", null,
    React.createElement("a", { href: "#about", onClick: props.toggleMenu }, "HAKKIMDA")),



    React.createElement("li", null,
    React.createElement("a", { href: "#projects", onClick: props.toggleMenu }, "ÇALIŞMALARIM")),



    React.createElement("li", null,
    React.createElement("a", { href: "#contact", onClick: props.toggleMenu }, "İLETİŞİM"))),
...
const Nav = props => {
  return (
    ...
    React.createElement("p", { className: "brand" }, "Enes",

    React.createElement("strong", null, "Onur"), "Ata"),
...
const Header = props => {
  return (
    ...
    React.createElement("a", { href: "#projects" }, "Çalışmalarım"),
    React.createElement("a", { href: "#contact", className: "cta" }, "İletişim")))));
...
const About = props => {
  return (
    ...
    React.createElement("h3", null, "Kim ulan bu?"),
    React.createElement("p", { className: "separator" })),

    React.createElement("div", { className: "desc full" },
    React.createElement("h4", { className: "subtitle" }, "Selam ben Enes Onur"),
    React.createElement("p", null, "Ankara'da yaşayan kendi halinde bir Web Developer."),



    React.createElement("p", null, "Sorunları çözmekten, kullanımı güzel ve kolay hale getirmekten gerçekten zevk alıyorum. Yeni şeyler öğrenmekten vazgeçemiyorum; ne kadar çok, o kadar iyi. Ayrıca bilgisayar oyunlarını seviyorum.")),
    ...
    React.createElement("div", { className: "title" },
    React.createElement("h3", null, "Neler yapıyorum?"),
    React.createElement("p", { className: "separator" })),
...
const Contact = props => {
  return (
    ...
    React.createElement("div", { className: "heading" },
    React.createElement("p", { className: "title" }, "Hey Dostum",
    React.createElement("br", null), "Bana instagramdan ulaşabilirsin"),


    React.createElement("p", { className: "separator" }),
    React.createElement("p", { className: "subtitle" }, "Please, use the form below or send an email to ",
    '',
    React.createElement("span", { className: "mail" }, "enesonurata68",
   ...
   React.createElement("div", { className: "buttons" },
   React.createElement("li", null)),
   React.createElement("a", { href: "https://instagram.com/EnesOnurATA/" }, "İnstagram Hesabım"),
   )));
...
const Footer = props => {
  return (
    ...
    React.createElement("div", { className: "wrapper" },
    React.createElement("h3", null, "ZİYARET ETTİĞİNİZ İÇİN TEŞEKKÜRLER"),
    React.createElement("p", null, "\xA9 ", new Date().getFullYear(), " Enes Onur Ata"),
    React.createElement(SocialLinks, null))));
...
const SocialLinks = props => {
  return (
    ...
    React.createElement("a", {
      href: "https://twitter.com/enesonurataa",
      target: "_blank",
    ...
    React.createElement("a", {
      id: "profile-link",
      href: "https://github.com/enesonurata",
      target: "_blank",
      rel: "noopener noreferrer",
    ...
    React.createElement("a", {
      href: "https://codepen.io/enesonurata",
      target: "_blank",
      rel: "noopener noreferrer",
      title: "Codepen Profilim" },
